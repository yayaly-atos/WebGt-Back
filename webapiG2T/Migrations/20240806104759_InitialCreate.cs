        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValeurPrecedente = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ValeurNouveau = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Historiques_Utilisateur_UtilisateurId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HistoriqueIncidentId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Incidents_Historiques_HistoriqueIncidentId",
                        column: x => x.HistoriqueIncidentId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Incidents_HistoriqueIncidentId",
                table: "Incidents",
                column: "HistoriqueIncidentId");
